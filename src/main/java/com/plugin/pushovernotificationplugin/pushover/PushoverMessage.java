package com.plugin.pushovernotificationplugin.pushover;
...
public class PushoverMessage {
  ...
  public static class Builder {
    ...
    /**
     * (required) - the user key (not e-mail address) of your user (or you), viewable when logged
     * into the dashboard
     */
    ...
    /**
     * (optional) - set to MessagePriority.HIGH to display as high-priority and bypass quiet hours,
     * or MessagePriority.QUIET to always send as a quiet notification
     */
    ...
    /**
     * (optional) - set to a Unix timestamp to have your message show with a particular time, rather
     * than now
     */
    ...
    /**
     * (optional) - set to the name of one of the sounds supported by device clients to override the
