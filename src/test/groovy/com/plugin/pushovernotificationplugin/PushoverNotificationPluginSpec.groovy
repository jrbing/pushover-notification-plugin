...
class PushoverNotificationPluginSpec extends Specification {
    ...
    def "Post Notification success"() {
        given:

          PushoverNotificationPlugin plugin = new PushoverNotificationPlugin();
          plugin.appApiToken = System.getenv("PUSHOVER_APP_API_TOKEN")
          plugin.userIdToken = System.getenv("PUSHOVER_USER_ID_TOKEN")
          println plugin.appApiToken
